...
class StripeWH_Handler:
    """
    Handles Stripe Webhooks (from Boutique Ado project)
    """
    ...
    def _send_confirmation_email(self, order):
        """
        Send the user a confirmation email upon a successful sale
        """
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        # Ensures the shipping data is in the same format as that in the
        # database by replacing any empty strings in the shipping details
        # with 'None'
        ...
        while attempt <= 5:
            ...
            try:
                ...
                order_exists = True
                break
            # If order not found then handler trys to create the order
            # database entry using data from the intent.
